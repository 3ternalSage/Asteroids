...
from constants import PLAYER_RADIUS, PLAYER_TURN_SPEED, PLAYER_THRUST_SPEED, PLAYER_SHOT_SPEED, PLAYER_SHOOT_CD
...
class Player(CircleShape):
    ...
    def move(self, dt):
        forward = pygame.Vector2(0, 1).rotate(self.rotation)
        self.position += forward * PLAYER_THRUST_SPEED * dt
